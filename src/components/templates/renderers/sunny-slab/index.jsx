...
export default function SunnySlabTemplate({ data, isPreview = false, isBuilder = false }) {
  ...
  const {
    ...
    foto_pria = "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&q=80",
    foto_wanita = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&q=80",
    foto_cover = "https://images.unsplash.com/photo-1519741497674-611481863552?w=1200&q=80",
    foto_urls = [],
