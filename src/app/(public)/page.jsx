...
import { ArrowRight, Sparkles, PenLine, CreditCard, Send, Quote, Star, LayoutTemplate } from "lucide-react";

import { dummyTemplates } from "@/lib/dummy-data";

export default function LandingPage() {
  const featuredTemplates = dummyTemplates.filter((t) => t.isFeatured);
